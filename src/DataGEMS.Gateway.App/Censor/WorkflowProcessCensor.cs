...
{
	public class WorkflowProcessCensor : ICensor
	{
		private readonly CensorFactory _censorFactory;
		private readonly IAuthorizationService _authService;
		private readonly ILogger<WorkflowProcessCensor> _logger;
		...
		public WorkflowProcessCensor(
			CensorFactory censorFactory,
			IAuthorizationService authService,
			ILogger<WorkflowProcessCensor> logger,
