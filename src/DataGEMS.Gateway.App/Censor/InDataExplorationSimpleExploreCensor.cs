...
{
	public class InDataExplorationSimpleExploreCensor : ICensor
	{
		private readonly CensorFactory _censorFactory;
		private readonly IAuthorizationService _authService;
		private readonly ILogger<InDataExplorationSimpleExploreCensor> _logger;
		...
		public InDataExplorationSimpleExploreCensor(
			CensorFactory censorFactory,
			IAuthorizationService authService,
			ILogger<InDataExplorationSimpleExploreCensor> logger,
		...
		{
			this._logger.Debug(new MapLogEntry("censoring").And("type", nameof(Model.InDataSimpleExploreExploration)).And("fields", fields).And("context", context));
