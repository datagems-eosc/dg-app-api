...
{
	public class InDataExplorationSqlCensor : ICensor
	{
		private readonly CensorFactory _censorFactory;
		private readonly IAuthorizationService _authService;
		private readonly ILogger<InDataExplorationSqlCensor> _logger;
		...
		public InDataExplorationSqlCensor(
			CensorFactory censorFactory,
			IAuthorizationService authService,
			ILogger<InDataExplorationSqlCensor> logger,
		...
		{
			this._logger.Debug(new MapLogEntry("censoring").And("type", nameof(Model.InDataTextToSqlExploration)).And("fields", fields).And("context", context));
