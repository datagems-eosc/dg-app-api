...
namespace DataGEMS.Gateway.Api.Controllers
{
	...
	public class CollectionController : ControllerBase
	{
		...
		public async Task<QueryResult<App.Model.Collection>> Query([FromBody] CollectionLookup lookup)
		{
		...
		[Authorize]
		[ModelStateValidationFilter]
		public async Task<App.Model.Collection> Get([FromRoute] Guid id, [ModelBinder(Name = "f")] IFieldSet fieldSet)
		{
