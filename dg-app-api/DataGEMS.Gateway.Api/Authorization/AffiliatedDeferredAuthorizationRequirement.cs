...
{
    public class AffiliatedDeferredAuthorizationRequirement : IAuthorizationRequirement
	{
		...
		public AffiliatedDeferredAuthorizationRequirement(List<String> requiredPermissions, Boolean matchAll = false)
		{
